...
class OpenAIClient:
    ...
    def create(self, params: Dict[str, Any]) -> ChatCompletion:
        ...
        if params.get("stream", False) and "messages" in params:
            ...
            # # 移除 stream=False 时的 stream_options
            # params = params.copy()  # 避免修改原始参数
            # if not params.get("stream", False) and "stream_options" in params:
            #     del params["stream_options"]
            #     print("Removed stream_options from params as stream is not enabled")
            
            #print("API request params:", params)  # 调试：打印请求参数
